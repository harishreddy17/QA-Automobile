...
class EnhancedChatbot:
    def __init__(self):
        ...
        self.conversation_history = deque(maxlen=10)  # Remember last 5 interactions
        self.context = {}
    ...
    def _query_knowledge_graph(self, entities):
    ...
    def _get_response_confidence(self, query, best_match, similarity):
    ...
    def _check_context_relevance(self, query):
    ...
    def _handle_ambiguous_query(self, query):
    ...
    def _learn_from_interaction(self, query, response, user_feedback):
    ...
    def _fill_template(self, template_key, variables):
        """Fill response template with variables"""
        return self.response_templates[template_key].format(**variables)
    
    def _generate_dynamic_response(self, base_response, query, context):
